...
public class ZonaFitForma extends JFrame {
    ...
    private void createUIComponents() {
        ...
        this.tablaModeloClientes = new DefaultTableModel(0, 4) {
            // Evita la edición de los valores de las celdas de la tabla
            @Override
        ...
        // Restringe la seleccion de la tabla a un solo registro
    ...
    private void guardarCliente() {
        ...
        cliente.setMembresia(Integer.parseInt(membresiaTexto.getText()));
    ...
    private void cargarClienteSeleccionado() {
        ...
        if (renglon != -1) { // -1 significa que no hay ninguno seleccionado
    ...
    private void limpiarFormulario() {
        // Limpiamos el id cliente seleccionado si hay
        idCliente = null;
